...
<head>
    ...
    <title>Informazioni PHP - LORIS BASSETTI</title>
    <style>
        body {
...
<body>
    <div class='header'>
        ...
        <p>Configurazione del server PHP per LORIS BASSETTI</p>
    </div>
    
    <div class='info-box'>
        <h2>📊 Dati Studente</h2>
        <p><strong>Nome:</strong> LORIS BASSETTI</p>
        <p><strong>Classe:</strong> 4CINF</p>
        <p><strong>Username:</strong> bassetti.loris</p>
